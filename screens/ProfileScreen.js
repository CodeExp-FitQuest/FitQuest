  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        <ChallengePanel title={"2.4KM Challenge"} description={"Finish 2.4KM under 15 minutes"} />
        <ChallengePanel title={"Sit Up Challenge"} description={"Perform 20 sit ups"} />
        <ChallengePanel title={"Push Up Challenge"} description={"Perform 35 push ups"} />
      </View>
    </View>
  );
};
